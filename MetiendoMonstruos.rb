...
class CartasMonstruos
	def initialize 
		...
		prize = Prize.new(4,1)
		badConsequence = BadConsequence.newNumberOfTreasures('Te atrapan para llevarte de fiesta y te dejan caer en mitad del vuelo. Pierdes una mano visible y otra oculta',
		0,1,1)
		@@monsters << Monster.new('Angeles de la noche ibicenca', 14, prize, badConsequence)

		#El gorron en el umbral
		prize = Prize.new(3,1)
		badConsequence = BadConsequence.newNumberOfTreasures('Pierdes todos tus tesoros visibles.', 0, 5, 5)
		...
		#El rey de la rosa
		prize = Prize.new(4,2)
		badConsequence = BadConsequence.newNumberOfTreasures('Pierdes 5 niveles y 3 tesoros visibles', 5, 3, 0)
		@@monsters << Monster.new('El rey de la rosa', 13, prize, badConsequence)

		#La que redacta en las tinieblas
		prize = Prize.new(1,1)
		badConsequence = BadConsequence.newNumberOfTreasures('Toses los pulmones y pierdes 2 niveles', 2, 0, 0)
		...
		#Semillas Cthulhu
		prize = Prize.new(2,1)
		badConsequence = BadConsequence.newNumberOfTreasures('Pierdes 2 niveles y 2 tesoros ocultos', 2, 0 ,2)
		...
		@@monsters << Monster.add('Dameargo', 1, prize, badConsequence)
